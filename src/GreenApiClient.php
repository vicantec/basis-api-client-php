...
use BasisApi\RestApi\tools\Account;
use BasisApi\RestApi\tools\Device;
use BasisApi\RestApi\tools\Groups;
use BasisApi\RestApi\tools\Journals;
use BasisApi\RestApi\tools\Marking;
use BasisApi\RestApi\tools\Queues;
use BasisApi\RestApi\tools\Receiving;
use BasisApi\RestApi\tools\Sending;
use BasisApi\RestApi\tools\ServiceMethods;
use BasisApi\RestApi\tools\Webhooks;
use stdClass;

class BasisApiClient {
	private $host;
	private $idInstance;
	...
	public function __construct( $idInstance, $apiTokenInstance, $host = 'https://api.basis-api.com' ) {
